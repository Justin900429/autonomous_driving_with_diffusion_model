...
class ZombieWalkerHandler(object):
    ...
    def _spawn(self, num_zombie_walkers, ev_spawn_locations, max_trial=10, tick=True):
        ...
        def proximity_to_ev(location):
            return any(
                [
                    ev_loc.distance(location) < self._spawn_distance_to_ev
